...
public class DatabaseHelper {
	...
	public static int updateProductIntoCart(CartItem cart) {
		String query = Query.updateProductIntoCartQuery(cart.getUserId(),cart.getProductCode());
		Connection connection = null;
		int rowAffected = 0;
		try {
			connection = SQLConnection.getConnection("ead_mvc");
	...
	public static int removeProductFromCart(CartItem cart) {
		String query = Query.removeProductFromCartQuery(cart.getUserId(),cart.getProductCode());
		Connection connection = null;
		int rowAffected = 0;
		try {
			connection = SQLConnection.getConnection("ead_mvc");
